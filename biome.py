...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.my_image1 = customtkinter.CTkImage(light_image=Image.open("D:\Studies\Engineering\Hackus2\python_gui\images\hand.png"), size=(30, 30))
        self.my_image2 = customtkinter.CTkImage(light_image=Image.open("D:\Studies\Engineering\Hackus2\python_gui\images\peas.jpg"), size=(30, 30))
        self.my_image3 = customtkinter.CTkImage(light_image=Image.open("D:\Studies\Engineering\Hackus2\python_gui\images\hand2.jpeg"), size=(30, 30))
